			...
			<div class="menu-sidebar__content js-scrollbar1">
				<nav class="navbar-sidebar">
					<ul class="list-unstyled navbar__list">
						<li class="active has-sub"><a class="js-arrow"
							href="adminHomeSupervisor.jsp"> <i class="fas fa-tachometer-alt"></i>Dashboard
						</a></li>
						
						<li><a href="supervisor_reg.jsp"> <i class="fas fa-table"></i>Supervisor
								Details
						</a></li>
						<li class=""><a class="js-arrow" href="companyDetailsSupervisor.jsp">
