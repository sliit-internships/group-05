...
<body>
	...
	<div class="wrapper">
		...
		<div class="form-wrapper"
			...
			<h1 style="color: white;" class="form-title">Supervisor Sign up</h1>

			<form id="form" action="SupervisorSysReg" onsubmit="return validation(); verifyPassword(); check();" method="post">
