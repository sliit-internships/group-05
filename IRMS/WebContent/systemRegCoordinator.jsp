...
<body>
	...
	<div class="wrapper">
		...
		<div class="form-wrapper"
			...
			<h1 style="color: white;" class="form-title">Coordinator Sign up</h1>

			<form id="form" action="CoordinatorSysReg" onsubmit="return validation(); verifyPassword(); check();" method="post">
