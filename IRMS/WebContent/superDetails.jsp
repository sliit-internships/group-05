                    ...
                    <ul class="navbar-mobile__list list-unstyled">
                        ...
                        <li>
                            <a href="studentDetails.jsp">
                                <i class="fas fa-chart-bar"></i>Student Details</a>
                        </li>
                        <li class="active has-sub">
                            <a class="js-arrow" href="superDetails.jsp">
                                <i class="fas fa-table"></i>Supervisor Details</a>
                        </li>
                        <li>
                            <a href="#">
                                <i class="far fa-check-square"></i>Forms Details</a>
                        </li>
                        <li>
                            <a href="adminCalander.jsp">
                            ...
                            <div class="col-lg-6">
                                <div class="au-card au-card--no-shadow au-card--no-pad m-b-40">
                                    <div class="au-card-title" style="background-image:url('images/bg-title-01.jpg');">
                                        ...
                                        <h3>
                                            <i class="zmdi zmdi-account-calendar"></i>29 November, 2020</h3>
                                                ...
                                                <div class="recei-mess-wrap">
                                                    ...
                                                    <div class="recei-mess__inner">
                                                        ...
                                                        <div class="recei-mess-list">
                                                            <div class="recei-mess">Dear sir, I have a problem with phase 1?</div>
                                                            <div class="recei-mess">Could you please tell me where i have to submit my files?</div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="send-mess-wrap">
                                                    ...
                                                    <div class="send-mess__inner">
                                                        <div class="send-mess-list">
                                                            <div class="send-mess">I will inform you with the email</div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
