			...
			<div class="menu-sidebar__content js-scrollbar1">
				<nav class="navbar-sidebar">
					<ul class="list-unstyled navbar__list">
						...
						<li class=""><a class="js-arrow" href="studentDetails.jsp">
								<i class="fas fa-chart-bar"></i>Student Details
						</a></li>
						<li><a href="superDetails.jsp"> <i class="fas fa-table"></i>Supervisor
								Details
						</a></li>
				...
				<div class="section__content section__content--p30">
					<div class="container-fluid">
						...
						<div class="row">
							...
							<div class="card" style="width: 18rem; heigth:35rem; margin-left: 5%;">
								<img class="card-img-top" src="https://ichef.bbci.co.uk/news/976/cpsprodpb/7098/production/_104842882_students.jpg" alt="Card image cap">
								<div class="card-body">
									<h5 class="card-title">Student</h5>
									<p class="card-text">Student Internship Registration</p>
									<a href="InternshipStudentReg.jsp" class="btn btn-primary">Go somewhere</a>
								</div>
							</div>

							<div class="card" style="width: 18rem; heigth:35rem; margin-left: 25%;">
								<img class="card-img-top" src="https://thumbs.dreamstime.com/z/people-three-persons-partnership-team-logo-company-friends-116505269.jpg" alt="Card image cap" >
								<div class="card-body">
									<h5 class="card-title">Supervisor</h5>
									<p class="card-text">Supervisor Registration</p>
