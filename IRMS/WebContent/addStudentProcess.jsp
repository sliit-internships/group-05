...
try {
			...
			String query = "insert into student_details values('"+studentId+"', '"+studentName+"', '"+specialization+"', '"+studentEmail+"', '"+supervisorEmail+"', '"+stuMobileNumber+"', '"+internshipStartDate+"', '"+currentYear+"','"+ plantoComplete2ndYear+"', '"+periodComplete2year+"')";
